  ...
  )
{
  ...
  OpteeSharedMemoryInformation.PhysicalBase = PhysicalAddress;
  OpteeSharedMemoryInformation.VirtualBase = PhysicalAddress;
  ...
  )
{
  ...
  DEBUG ((DEBUG_ERROR, "Optee: set virtual address map\n"));
#if 0
